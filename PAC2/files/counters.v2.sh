...
do
    ...
    MISSES=$(sed -n -r '/Level 3 total cache misses/s/.* = (.*)/\1/p' ${OUT_FILE})
...
sort -o $FILE $FILE
#gsed -i '1i host,l3_cache_misses,flops,instructions' $FILE
sed -i '1i host,l3_cache_misses,flops,instructions' $FILE
